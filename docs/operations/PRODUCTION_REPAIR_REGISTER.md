...
| REP-011 | Marketplace  |  P0 | `billing.ts`, `marketplace-repository.ts` | `DEFAULT_MARKETPLACE_LISTINGS` como fuente económica en código (in-memory).                                                                                                                                                                                                      | La lectura y creación usan `marketplace_listings` mediante `MARKETPLACE_REPOSITORY`; sin DATABASE_URL falla cerrado y no existe fallback económico en memoria.                                                                | repository + migration + billing tests                                           | TESTED                                                                                                                 |
