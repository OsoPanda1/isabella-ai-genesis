...
export const ISABELLA_SKILLS: readonly IsabellaSkill[] = [
  ...
  { id: "marketplace-browse", name: "Marketplace", description: "Explora ofertas, productos y servicios territoriales — lectura paginada con tenant isolation.", folder: "Economía", subfolder: "Marketplace", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
  { id: "offer-create", name: "Crear oferta", description: "Crea oferta con idempotencia, validación Zod y auditoría — requiere approval si riesgo alto.", folder: "Economía", subfolder: "Marketplace", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
  { id: "gift-redeem", name: "Gifts y Rewards", description: "Redime gifts con verificación de saldo, idempotencia y ledger append-only.", folder: "Economía", subfolder: "Marketplace", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
  { id: "payout-request", name: "Solicitar payout", description: "Solicita retiro 85/15 con reserva, disputa retenida y payout idempotente.", folder: "Economía", subfolder: "Payouts", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
  { id: "payout-verify", name: "Verificar payout", description: "Verifica estado de payout, firma y reconciliación — solo lectura con RLS.", folder: "Economía", subfolder: "Payouts", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
  { id: "monetization-analytics", name: "Analíticas de monetización", description: "Consulta métricas de consumo, ingresos y distribución territorial con RBAC.", folder: "Economía", subfolder: "Analíticas", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
  { id: "creator-coach", name: "Coach del creador", description: "Asiste perfil → coach → skills → boosters → studio → assets con provenance.", folder: "Economía", subfolder: "Creator OS", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
  { id: "skill-boost", name: "Boosters", description: "Aplica boosters de claridad, narrativa y localización sin prometer viralidad.", folder: "Economía", subfolder: "Creator OS", capability: "monetization", status: "implemented", requiredScopes: ["isabella:chat"] },
];
