...
export const ENV_VAR_CATALOG: EnvVarDescriptor[] = [
  ...
  },
  {
    ...
    provider: "self",
    criticality: "HIGH",
    description: "Opt-in explícito para Ollama local.",
  },
  {
  ...
  },
  {
    ...
    provider: "self",
    criticality: "HIGH",
    description: "Opt-in explícito para backend local compatible.",
  },
  {
  ...
  },
  {
    ...
    provider: "self",
    criticality: "LOW",
    description: "Opt-in de comprensión nativa (NCUA) en el gateway conversacional.",
  },
];
