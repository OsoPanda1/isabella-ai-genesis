...
export class ClaimEngine {
  ...
  private collectEvidenceFromScans(): void {
    ...
    // Source scanner -> SOURCE_CODE evidence
    ...
    // Security scanner -> SECURITY_TEST evidence (for critical patterns)
    ...
    // Database scanner -> DATABASE evidence
    ...
    // Financial scanner -> FINANCIAL_TEST evidence
    ...
    // Governance scanner -> POLICY_DOCUMENT, ADR evidence
