...
const SKILL_PROFILES: Array<{
  ...
  },
  {
    ...
    number: 738,
    domain: "design_brand",
    keywords: ["slides", "presentacion", "deck", "pitch", "diapositivas", "conferencia", "pitchdeck"],
  ...
  },
  {
    ...
    number: 740,
    domain: "quality_engineering",
    keywords: ["devtools", "chrome", "vitals", "lcp", "cls", "inp", "lighthouse", "consola", "browser"],
  ...
  },
  {
    ...
    number: 741,
    domain: "web_monitoring",
    keywords: ["seo", "audit", "opengraph", "json-ld", "schema", "robots", "sitemap", "indexabilidad"],
  ...
  },
  {
    ...
    number: 742,
    domain: "design_brand",
    keywords: ["infografia", "infographic", "svg", "esquema", "diagrama", "visual", "flujo", "baoyu"],
  ...
  },
  {
    ...
    number: 743,
    domain: "deep_search",
    keywords: ["knowledge", "base", "rag", "docs", "documentacion", "markdown", "chunks", "scraping"],
  ...
  },
  {
    ...
    number: 748,
    domain: "quality_engineering",
    keywords: ["swiftui", "swift", "observable", "ios", "macos", "view", "navigationstack", "apple"],
  ...
  },
  {
    ...
    number: 750,
    domain: "market_intelligence",
    keywords: ["lead", "gen", "prospeccion", "b2b", "empresas", "directorio", "ventas", "calificacion"],
    weights: [2.1, 1.7, 1.5, 1.2],
    bias: -0.8,
  },
  {
    ...
    number: 751,
    domain: "devops_launch",
    keywords: ["launch", "shipping", "lanzamiento", "checklist", "produccion", "rollback", "salida"],
    weights: [2.2, 1.8, 1.6, 1.3],
    bias: -0.9,
  },
  {
    ...
    number: 752,
    domain: "market_intelligence",
    keywords: ["lead-research", "dossier", "cuenta", "organizacion", "perfil", "analisis", "prospecto"],
    weights: [2.0, 1.7, 1.5, 1.3],
    bias: -0.8,
  },
  {
  ...
  },
  {
    ...
    number: 754,
    domain: "market_intelligence",
    keywords: ["competitiva", "intel", "inteligencia", "paridad", "competidor", "contraposicionamiento"],
...
export function skillResultToKnowledgeObservation(
  ...
  const domainMap: Record<string, "factual" | "technical" | "operational" | "creative" | "security"> = {
