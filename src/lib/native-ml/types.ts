/**
 * Isabella Native ML — contratos soberanos y agnósticos al proveedor.
...
export interface NativeMLHooks {
  authorize?: (input: { action: string; territoryId: string; modelId?: string }) => Promise<NativeMLPolicyDecision> | NativeMLPolicyDecision;
  audit?: (event: string, payload: Record<string, unknown>) => Promise<string | void> | string | void;
}
