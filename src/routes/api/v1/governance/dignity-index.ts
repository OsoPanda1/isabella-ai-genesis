      ...
      GET: withSovereignAuth("system", "read", async (ctx, req) => {
        ...
        return new Response(
          JSON.stringify({
            ...
            implementation: "idh-d-v3",
            evidenceStatus: result.evidenceStatus,
            data: {
              ...result,
              appeal: appeal ? idhdAppealRoute(ctx.tenantId, result.score) : undefined,
              policy: config().CROWN_CONSTITUTION_VERSION,
              note: "IDH-D es indicador de gobernanza, no bloqueo automático sin revisión y apelación (Cap. IX)",
            },
            error: null,
          }),
          { status: 200, headers },
