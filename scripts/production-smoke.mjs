...
if (!input) {
  console.error("Uso: node scripts/production-smoke.mjs <https://host> o PRODUCTION_SMOKE_URL.");
  process.exit(2);
}
const base = new URL(input);
const checks = [
  { path: "/", expected: "2xx" },
  { path: "/api/health/ready", expected: "2xx" },
];
const results = [];
...
console.log(
  JSON.stringify(
    {
      schema: "isabella.production-smoke.v1",
      baseUrl: base.origin,
